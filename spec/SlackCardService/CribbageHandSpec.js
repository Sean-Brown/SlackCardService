...
var image_manager_1 = require("../../routes/Cribbage/helpers/image_manager");
"use strict";
describe("Test a Cribbage game between two players", function () {
    ...
    describe("Test various counting scenarios", function () {
        ...
        it("is able to show a player's cards", function (done) {
            ...
            var user = "TestUser";
            var imageManager = new image_manager_1.ImageManager();
            imageManager.createPlayerHandImageAsync(user, new cribbage_hand_1.CribbageHand([
                aceOfClubs,
                twoOfClubs,
                threeOfDiamonds,
                fourOfSpades,
