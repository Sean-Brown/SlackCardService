...
import {hand_history_actions} from "../../../../db/implementation/postgres/hand_history_actions";
import {HandHistoryReturn} from "../../../../db/abstraction/return/db_return";
var Q = require("q");
...
function createHandHistory(player_id:number, game_history_id:number): Q.Promise<HandHistory> {
    return new Q.Promise((resolve) => {
        hand_history_actions.create(player_id, game_history_id, hand, cut).then((ret: HandHistoryReturn) => {
